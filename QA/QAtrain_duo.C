...
//    tofQA->SelectCollisionCandidates(kTriggerMask);
 ...
 //   tofQA->SelectCollisionCandidates(kTriggerMask);
  ...
  if (doPHOSTrig)
  {
    ...
    AliAnalysisTaskPHOSTriggerQA *taskPHOSTrig1 = AddTaskPHOSTriggerQA(NULL,"PHOSTriggerQAResultsL0");
    
    AliAnalysisTaskPHOSTriggerQA* taskPHOSTrig2 = AddTaskPHOSTriggerQA(NULL,"PHOSTriggerQAResultsL1High");
    taskPHOSTrig2->SelectL1Threshold(0);
    
    AliAnalysisTaskPHOSTriggerQA* taskPHOSTrig3 = AddTaskPHOSTriggerQA(NULL,"PHOSTriggerQAResultsL1Medium");
    taskPHOSTrig3->SelectL1Threshold(1);
    
    AliAnalysisTaskPHOSTriggerQA* taskPHOSTrig4 = AddTaskPHOSTriggerQA(NULL,"PHOSTriggerQAResultsL1Low");
