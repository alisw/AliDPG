...
//-------------------------------------------------------------------------
AliGenerator* Muon_GenParamCustomSingle_2016_1()
{
...
Double_t PtMuon( const Double_t *px, const Double_t */*dummy*/ )
{
  ...
  //Default param. = tuned MSL LHC16k
  p0 = 631.905;//135.137
  p1 = 0.947351;//0.555323
  p2 = 0.612753;//0.578374
  p3 = 9.45906;//10.1345
  p4 = 0.0559408;//0.000232233
  p5 = -4.68074;//-0.924726
