//--------------------------------------------------------------------------------------------------//
//                     MC production for muon Upsilon analysis in pPb at 8.16TeV                    //
//                                                                                                  //
...
Double_t PtUpsilon(const Double_t *x, const Double_t */*dummy*/)
{
  // Upsilon pT tuned on accEff corrected Upsilon(1S) yields in pPb data at 8.16TeV
...
Double_t YUpsilon(const Double_t *x, const Double_t */*dummy*/)
{
  // Upsilon y tuned on accEff corrected Upsilon(1S) yields in pPb data at 8.16TeV

  Double_t y = *x;

  Double_t p0 = 1.66335e+03;
  Double_t p1 = -4.53270e-02;
