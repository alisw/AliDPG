AliGenerator* GeneratorCustom(TString opt = "")
{
  ...
  TString optNames[nParametrizations] = {
    "HF_single_pPbcmsl16r",
    "HF_single_Pbpcmsl16s",
    "HF_single_pPbcmsh16r",
    "HF_single_Pbpcmsh16s",
//     "jpsi_PbPb5TeV_1",
//     "Charmonia_pp13TeV_1"
  };
  TString optMacros[nParametrizations] = {
    "HF_Muon_GenParamSingle_pPb_CMSL_16r.C",
    "HF_Muon_GenParamSingle_Pbp_CMSL_16s.C",
    "HF_Muon_GenParamSingle_pPb_CMSH_16r.C",
    "HF_Muon_GenParamSingle_Pbp_CMSH_16s.C",
//     "HF_Muon_GenParamJpsi_PbPb5TeV_1.C",
//     "HF_Muon_GenParamCharmonia_pp13TeV_1.C"
  };
  ...
  if (opt == "custom") {
    ...
    for (Int_t iPar = 0; iPar < nParametrizations; iPar++) {
      if (opt == optNames[iPar]) {
        macro += "$ALIDPG_ROOT/MC/CustomGenerators/PWGHF/";
