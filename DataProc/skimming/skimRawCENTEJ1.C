...
// Used for CENT cluster EJ1 triggers from PbPb 2018 data
// 21.11.2018
// Martin Poghosyan (adaption Markus Fasel including 
// central barrel detectors for EJ1/EG1-triggered events in CENT(NOPMD))
/////////////////////////////////////////////
...
Bool_t skimRawCENTEJ1(const char* list = "wn.xml")
{
  ...
  for( Int_t iclass=0; iclass < nclasses; iclass++ ) {
    ...
    if(!clname.Contains("CENT") || !(clname.Contains("EJ1")  || clname.Contains("EG1")) )
      continue;
