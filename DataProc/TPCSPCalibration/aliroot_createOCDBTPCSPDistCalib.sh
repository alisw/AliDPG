...
EXECUTABLE=$ALIDPG_ROOT/DataProc/TPCSPCalibration/createOCDBTPCSPDistCalib.sh
if [ -f createOCDBTPCSPDistCalib.sh ]; then
    chmod +x createOCDBTPCSPDistCalib.sh
    EXECUTABLE=./createOCDBTPCSPDistCalib.sh
fi
