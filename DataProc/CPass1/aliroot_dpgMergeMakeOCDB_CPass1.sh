...
DPGSIMSH=$ALIDPG_ROOT/DataProc/CPass1/mergeMakeOCDB.byComponent.perStage.sh
if [ -f mergeMakeOCDB.byComponent.perStage.sh ]; then
    chmod +x mergeMakeOCDB.byComponent.perStage.sh
    DPGSIMSH=./mergeMakeOCDB.byComponent.perStage.sh
fi
